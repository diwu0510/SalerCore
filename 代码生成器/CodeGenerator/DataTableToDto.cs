...
namespace CodeGenerator
{
    public class DataTableToDto
    {
        public static string Get(DbTable table, string namespaceName)
        {
            ...
            sb.Append("namespace " + namespaceName + ".Application" + Environment.NewLine);
            sb.Append("{" + Environment.NewLine);
            
            sb.Append("    public partial class " + className + "Dto" + Environment.NewLine);
            sb.Append("    {" + Environment.NewLine);
            string[] ignoreColumns = new string[] { "IsDel", "CreateAt", "CreateBy", "Creator", "UpdateAt", "UpdateBy", "Updator" };
